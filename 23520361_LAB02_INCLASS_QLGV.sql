...
ALTER TABLE GIANGDAY ADD CONSTRAINT CHK_MON CHECK(TUNGAY < DEMNGAY);

--13 Giáo viên khi vào làm ít nhất là 22 tuổi.
ALTER TABLE GIAOVIEN ADD CONSTRAINT CHK_TUOIGV CHECK(GETDATE() - NGSINH >=22);

--14 Tất cả các môn học đều có số tín chỉ lý thuyết và tín chỉ thực hành chênh lệch nhau không quá 3.
ALTER TABLE MONHOC ADD CONSTRAINT CHK_TINCHI CHECK (TCLT-TCTH <=3);
...
INSERT INTO GIANGDAY(MALOP, MAMH, MAGV, HOCKY, NAM, TUNGAY, DEMNGAY) VALUES
...
('K11', 'CTRR', 'GV02', 1, 2006, '2006-09-01', '2006-12-05'),
('K12', 'CTRR', 'GV02', 1, 2006, '2006-09-01', '2006-12-05'),
('K13', 'CTRR', 'GV08', 1, 2006, '2006-09-01', '2006-12-05'),
...
SELECT DISTINCT HOCVIEN.MAHV,KETQUATHI.MAMH, HOCVIEN.HO, HOCVIEN.TEN, KETQUATHI.LANTHI, KETQUATHI.DIEM
FROM HOCVIEN
...
WHERE KETQUATHI.KQUA = 'Dat' AND KETQUATHI.LANTHI = 1;

--4 In ra danh sách những học viên (mã học viên, họ tên) và những môn học mà học viên đó thi lần thứ nhất đã đạt.
...
FROM HOCVIEN
JOIN KETQUATHI ON HOCVIEN.MAHV = KETQUATHI.MAHV
WHERE KETQUATHI.MAMH = 'CTRR' AND KETQUATHI.KQUA = 'Khong Dat' AND KETQUATHI.LANTHI = 1 AND HOCVIEN.MALOP LIKE '%K%';